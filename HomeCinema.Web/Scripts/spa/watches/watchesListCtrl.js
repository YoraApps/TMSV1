(function (app) {
    ...
    app.controller('watcheslistCtrl', watcheslistCtrl);

    watcheslistCtrl.$inject = ['$scope', '$location', '$routeParams', '$modal', 'apiService', 'notificationService'];

    function watcheslistCtrl($scope, $location, $routeParams, $modal, apiService, notificationService) {
