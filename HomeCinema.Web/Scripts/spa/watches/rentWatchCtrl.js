(function (app) {
    ...
    app.controller('rentWatchCtrl', rentWatchCtrl);

    rentWatchCtrl.$inject = ['$scope', '$modalInstance', '$location', 'apiService', 'notificationService'];

    function rentWatchCtrl($scope, $modalInstance, $location, apiService, notificationService) {
        $scope.title = 'rentWatchCtrl';     
